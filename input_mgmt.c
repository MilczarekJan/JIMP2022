...
char    *help = "Usage: %s -m mode -n filename [-f number] [-t number] [-y precise number] [-z precise number] [-c number] [-r number] [-i true/false] (-h/help)\n"
                "m - mode [read/write]\n"
                ...
                "i - is the graph supposed to be cohesive? (default: true) [true/t/false/f]\n"
